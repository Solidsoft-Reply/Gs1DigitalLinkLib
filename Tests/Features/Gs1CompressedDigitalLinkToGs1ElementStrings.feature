Feature: Gs1CompressedDigitalLinkToGs1ElementStrings

Scenario Outline: Convert an uncompressed Digital Link to an element string
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
    When I convert the compressed Digital Link to an element string
    Then the element string should be "<elementString>"
...
Scenario Outline: Convert an uncompressed Digital Link to an element string with brackets
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
...
Scenario Outline: Convert an uncompressed Digital Link using short text to an element string
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
    When I convert the compressed Digital Link to an element string
    Then the element string should be "<elementString>"
...
Scenario Outline: Convert an uncompressed Digital Link using short text to an element string with brackets
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
    When I convert the compressed Digital Link to an element string with brackets
    Then the element string should be "<elementString>"
...
Scenario Outline: Convert a compressed Digital Link for a medicinal identifier to an element string
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
    When I convert the compressed Digital Link to an element string
    Then the element string should be "<elementString>"
...
Scenario Outline: Convert a compressed Digital Link for a medicinal identifier to an element string with brackets
    Given I want to convert the following compressed Digital Link to an element string: "<digitalLink>"
    When I convert the compressed Digital Link to an element string with brackets
    Then the element string should be "<elementString>"
